export default {
  fa_IR: {
    ...
    dashSupport: {
      ...
      no_data: "یک گفت و گوی جدید آغاز کنید",
      topic: "عنوان",
      is_terminated: "وضعیت",
      finish: "پایان یافته",
      continue: "در حال بررسی",
      page_title: "پیشخان - پشتیبانی",
      title: "عنوان:",
      titlePlace: "یک عنوان مناسب بنویسید.",
      internal_error: "مشکلی در سیستم رخ داده است ",
      invalid_input: "ورودی‌های مناسب را وارد کنید",
      ...
      message: "پیام مربوطه",
      explain:
        "ابتدا مشکل خود را توضیح دهید و مرحله‌ای که دچار مشکل شده‌اید را با جزئیات بیشتر شرح دهید.",
  ...
  en_US: {
    ...
    dashSupport: {
      ...
      no_data: "Start a new conversation",
      topic: "Topic",
      finish: "Finish",
      continue: "Continue",
      internal_error: "internal error in service",
      invalid_input: "Enter valid input",
